...
阶段文档给出 32 周排期和四列表格；[逐节课程教程](tutorials/README.md)进一步把 224 节课逐节展开为“为什么学、这个是什么、怎么学、怎么验证学会了”，并提供独立尝试后使用的参考答案。课程仓库的 `deliverables/week-XX/README.md` 只定义公共要求；个人进度和通过状态以个人学习仓库的同路径文件为准。
